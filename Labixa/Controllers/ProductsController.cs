...
namespace Labixa.Controllers
{
    public class ProductsController : BaseHomeController
    {
        ...
        public ProductsController(IProductService productService, IBlogService blogService,
        ...
        public ActionResult Products(int? page)
        {
            ...
            int pageSize = 12;
            var listProduct = _productService.GetProducts().Where(p => p.ProductCategory.Id == 1);
